...
public class LibraryJavaSound extends Library {
	...
	private static synchronized Mixer mixer(boolean action, Mixer m) {
		if (action == SET) {
			...
			try {
				...
				SoundSystemConfig.getLogger().printException(ljse);
	...
	public static class Exception extends SoundSystemException {
		/**
		 * The private generated serialVersionUID generated by Eclipse
		 */
		private static final long serialVersionUID = -2993087157562800018L;
