 ...
 * http://www.j-ogg.de and copyrighted by Tor-Einar Jarnbjo. </b><br>
 * <br>
 * <b><i> J-Ogg License:</b></i> <br>
 * <i> You are free to use, modify, resdistribute or include this software in
 * your own free or commercial software. The only restriction is, that you make
 * it obvious that your software is based on J-Ogg by including this notice in
 * the documentation, about box or whereever you feel apropriate: <br>
 * "This software is based on or using the J-Ogg library available from
 * http://www.j-ogg.de and copyrighted by Tor-Einar Jarnbjo." <br>
 * <br>
 * <br>
 * </i> <b><i> SoundSystem CodecJOgg License:</b></i><br>
 * <b><br>
 ...
 * 1) You must abide by the conditions of the aforementioned J-Ogg License. <br>
 * 2) You may not falsely claim to be the author of this class or any unmodified
 * portion of it. <br>
 * 3) You may not copyright this class or a modified version of it and then sue
 ...
 * 5) You are not required to give me credit for this class in any derived work,
...
public class CodecJOgg implements ICodec {
	 ...
	 * before returning it in the read() and readAll() methods. The J-Ogg
	 * library produces audio data in a format that some external audio
	 ...
	 * reversed will call the reverseByteOrder() method.
	 * 
	 * @param b
	...
	public boolean initialize(URL url) {
		...
		try {
			...
			myLogicalOggStream = (LogicalOggStream) cachedUrlStream
	...
	private class OggInputStream extends InputStream {
		 ...
		 * 
		 * @param source
		 *            VorbisStream for the ogg file to read from.
		 */
		...
		/**
		 * Implements the InputStream.read() method. Reads the next byte of data
		...
		/**
		 * Overrides the InputStream.read( byte[], int, int ) method. Reads up
		 * to length bytes of data from the input stream into an array of bytes.
		 * 
		 * @param buffer
		 *            Where to put the read-in data.
		 * @param offset
		 *            Position within buffer to place the data.
		 * @param length
		 *            How much data to read in.
		 * @return The total number of bytes read into the buffer, or -1 if EOS.
		 */
		@Override
