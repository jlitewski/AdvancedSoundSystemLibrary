 ...
 */
public class LWJGLSoundSystem implements ISoundSystem, ICodecable,
		ISoundLibrary<LibraryLWJGLOpenAL>, IDimensionalSound, IManager {
	...
	public void initialize() {
		this.logger.info("ASSL_initialize", "Initializing LWJGLSoundSystem...", 0);
		try {
			this.logger.info("ASSL_initialize", "Linking Library 'LibraryLWJGLOpenAL'...", 1);
			SoundSystemConfig.addLibrary(LibraryLWJGLOpenAL.class);

			this.logger.info("ASSL_initialize", "Linking " + this.codecCount + " Codecs...", 1);
		...
		this.logger.info("ASSL_initialize", "LWJGLSoundSystem set up sucessfully", 0);
	}

	@Override
	public int queue(URI soundPath, String filename, boolean isLooped,
			boolean priority) {
		int index = -1;
		try {
